...
namespace VetMedikaDiplomenProekt.Controllers
{
    public class HoursController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Time,RegisterOn,DateRegister")] Hour hour)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Time,RegisterOn,DateRegister")] Hour hour)
        {
            if (id != hour.Id)
            {
                return NotFound();
